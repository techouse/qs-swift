...
- (void)test_E2E_encode_decode_parametrized {
  ...
  id root = [SPMOrdered dictWithKeys:@[ @"a", @"c", @"e", @"i" ] values:@[ @"b", @"d", @[ @"f", @"g", @"h" ], subI ]];
  [cases addObject:@{ @"data" : root, @"encoded" : @"a=b&c=d&e[0]=f&e[1]=g&e[2]=h&i[j]=k&i[l]=m" }];

  // a[b]=c
  id a1 = [SPMOrdered dictWithKeys:@[ @"b" ] values:@[ @"c" ]];
  [cases addObject:@{ @"data" : [SPMOrdered dictWithKeys:@[ @"a" ] values:@[ a1 ]], @"encoded" : @"a[b]=c" }];
  ...
  [cases addObject:@{
    ...
    @"encoded" : @"filters[$or][0][date][$eq]=2020-01-01&filters[$or][1][date][$eq]=2020-01-02&filters[author][name][$"
                 @"eq]=John Doe"
  }];
  ...
  [cases addObject:@{
    @"data" : cERoot,
    @"encoded" :
        @"commentsEmbedResponse[0][id]=1&commentsEmbedResponse[0][post_id]=1&commentsEmbedResponse[0][someId]=ma018-"
        @"9ha12&commentsEmbedResponse[0][text]=Hello&commentsEmbedResponse[0][replies][0][id]=3&commentsEmbedResponse["
        @"0][replies][0][comment_id]=1&commentsEmbedResponse[0][replies][0][someId]=ma020-9ha15&commentsEmbedResponse["
        @"0][replies][0][text]=Hello&commentsEmbedResponse[1][id]=2&commentsEmbedResponse[1][post_id]=1&"
        @"commentsEmbedResponse[1][someId]=mw012-7ha19&commentsEmbedResponse[1][text]=How are "
        @"you?&commentsEmbedResponse[1][replies][0][id]=4&commentsEmbedResponse[1][replies][0][comment_id]=2&"
        @"commentsEmbedResponse[1][replies][0][someId]=mw023-9ha18&commentsEmbedResponse[1][replies][0][text]=Hello&"
        @"commentsEmbedResponse[1][replies][1][id]=5&commentsEmbedResponse[1][replies][1][comment_id]=2&"
        @"commentsEmbedResponse[1][replies][1][someId]=mw035-0ha22&commentsEmbedResponse[1][replies][1][text]=Hello"
  }];
...
- (void)test_E2E_encode_decode_fullMatrix {
  ...
  // 0) {}
  [cases addObject:@{ @"data" : [SPMOrdered dictWithKeys:@[] values:@[]], @"encoded" : @"" }];

  // 1) a=b
  [cases addObject:@{ @"data" : [SPMOrdered dictWithKeys:@[ @"a" ] values:@[ @"b" ]], @"encoded" : @"a=b" }];
  ...
  [cases addObject:@{
    @"data" : [SPMOrdered dictWithKeys:@[ @"a", @"c", @"e" ] values:@[ @"b", @"d", @[ @"f", @"g", @"h" ] ]],
  ...
  [cases addObject:@{ @"data" : [SPMOrdered dictWithKeys:@[ @"a" ] values:@[ b_c ]], @"encoded" : @"a[b]=c" }];

  // 6) a[b][c]=d
  id c_d = [SPMOrdered dictWithKeys:@[ @"c" ] values:@[ @"d" ]];
  id b_cd = [SPMOrdered dictWithKeys:@[ @"b" ] values:@[ c_d ]];
  [cases addObject:@{ @"data" : [SPMOrdered dictWithKeys:@[ @"a" ] values:@[ b_cd ]], @"encoded" : @"a[b][c]=d" }];
  ...
  // 8) a[0]=f
  [cases addObject:@{ @"data" : [SPMOrdered dictWithKeys:@[ @"a" ] values:@[ @[ @"f" ] ]], @"encoded" : @"a[0]=f" }];

  // 9) a[0][b][0]=c
  id deep = [SPMOrdered dictWithKeys:@[ @"b" ] values:@[ @[ @"c" ] ]];
  [cases
      addObject:@{ @"data" : [SPMOrdered dictWithKeys:@[ @"a" ] values:@[ @[ deep ] ]], @"encoded" : @"a[0][b][0]=c" }];

  // 10) a=
  [cases addObject:@{ @"data" : [SPMOrdered dictWithKeys:@[ @"a" ] values:@[ @"" ]], @"encoded" : @"a=" }];
  ...
  [cases addObject:@{ @"data" : [SPMOrdered dictWithKeys:@[ @"キー" ] values:@[ @"値" ]], @"encoded" : @"キー=値" }];
  [cases addObject:@{ @"data" : [SPMOrdered dictWithKeys:@[ @"🙂" ] values:@[ @"😊" ]], @"encoded" : @"🙂=😊" }];
  ...
  id c0 = [SPMOrdered dictWithKeys:@[ @"id", @"post_id", @"someId", @"text", @"replies" ]
                            values:@[
                              @"1", @"1", @"ma018-9ha12", @"Hello",
                              @[ [SPMOrdered dictWithKeys:@[ @"id", @"comment_id", @"someId", @"text" ]
                                                   values:@[ @"3", @"1", @"ma020-9ha15", @"Hello" ]] ]
                            ]];
  id c1 = [SPMOrdered dictWithKeys:@[ @"id", @"post_id", @"someId", @"text", @"replies" ]
                            values:@[
                              @"2", @"1", @"mw012-7ha19", @"How are you?",
                              @[
                                [SPMOrdered dictWithKeys:@[ @"id", @"comment_id", @"someId", @"text" ]
                                                  values:@[ @"4", @"2", @"mw023-9ha18", @"Hello" ]],
                                [SPMOrdered dictWithKeys:@[ @"id", @"comment_id", @"someId", @"text" ]
  ...
  [cases addObject:@{
    @"data" : comments,
    @"encoded" : @"commentsResponse[0][id]=1&commentsResponse[0][post_id]=1&commentsResponse[0][someId]=ma018-9ha12&"
                 @"commentsResponse[0][text]=Hello&commentsResponse[0][replies][0][id]=3&commentsResponse[0][replies]["
                 @"0][comment_id]=1&commentsResponse[0][replies][0][someId]=ma020-9ha15&commentsResponse[0][replies][0]"
                 @"[text]=Hello&commentsResponse[1][id]=2&commentsResponse[1][post_id]=1&commentsResponse[1][someId]="
                 @"mw012-7ha19&commentsResponse[1][text]=How are "
                 @"you?&commentsResponse[1][replies][0][id]=4&commentsResponse[1][replies][0][comment_id]=2&"
                 @"commentsResponse[1][replies][0][someId]=mw023-9ha18&commentsResponse[1][replies][0][text]=Hello&"
                 @"commentsResponse[1][replies][1][id]=5&commentsResponse[1][replies][1][comment_id]=2&"
                 @"commentsResponse[1][replies][1][someId]=mw035-0ha22&commentsResponse[1][replies][1][text]=Hello"
  }];
  ...
  [cases addObject:@{
    ...
    @"encoded" : @"data[id]=1&data[someId]=af621-4aa41&data[text]=Lorem Ipsum "
                 @"Dolor&data[user][firstname]=John&data[user][lastname]=Doe&data[user][age]=25&data[relationships]["
                 @"tags][data][0][name]=super&data[relationships][tags][data][1][name]=awesome"
  }];
  ...
  [cases addObject:@{
    @"data" : flat,
    @"encoded" : @"id=1&someId=af621-4aa41&text=Lorem Ipsum "
                 @"Dolor&user[firstname]=John&user[lastname]=Doe&user[age]=25&relationships[tags][0][name]=super&"
                 @"relationships[tags][1][name]=awesome"
  }];
  ...
  [cases addObject:@{
    @"data" : postsResponse,
    @"encoded" :
        @"postsResponse[0][id]=1&postsResponse[0][someId]=du761-8bc98&postsResponse[0][text]=Lorem Ipsum "
        @"Dolor&postsResponse[0][user][firstname]=John&postsResponse[0][user][lastname]=Doe&postsResponse[0][user][age]"
        @"=25&postsResponse[0][relationships][tags][0][name]=super&postsResponse[0][relationships][tags][1][name]="
        @"awesome&postsResponse[1][id]=1&postsResponse[1][someId]=pa813-7jx02&postsResponse[1][text]=Lorem Ipsum "
        @"Dolor&postsResponse[1][user][firstname]=Mary&postsResponse[1][user][lastname]=Doe&postsResponse[1][user][age]"
        @"=25&postsResponse[1][relationships][tags][0][name]=super&postsResponse[1][relationships][tags][1][name]="
        @"awesome"
  }];

  // 19) posts […] & total=2
  id posts = [SPMOrdered dictWithKeys:@[ @"posts", @"total" ] values:@[ @[ pR0, pR1 ], @"2" ]];
  [cases addObject:@{
    @"data" : posts,
    @"encoded" : @"posts[0][id]=1&posts[0][someId]=du761-8bc98&posts[0][text]=Lorem Ipsum "
                 @"Dolor&posts[0][user][firstname]=John&posts[0][user][lastname]=Doe&posts[0][user][age]=25&posts[0]["
                 @"relationships][tags][0][name]=super&posts[0][relationships][tags][1][name]=awesome&posts[1][id]=1&"
                 @"posts[1][someId]=pa813-7jx02&posts[1][text]=Lorem Ipsum "
                 @"Dolor&posts[1][user][firstname]=Mary&posts[1][user][lastname]=Doe&posts[1][user][age]=25&posts[1]["
                 @"relationships][tags][0][name]=super&posts[1][relationships][tags][1][name]=awesome&total=2"
  }];
