...
public final class SPMOrdered: NSObject {
  ...
  @objc
  public static func dictWithKeys(_ keys: [NSString], values: [Any]) -> Any {
...
public final class QsObjCTestHelpers: NSObject {
  @objc
  public static func encode(_ obj: Any, options: EncodeOptionsObjC?) -> NSString? {
    QsBridge.encode(obj, options: options, error: nil)
  }
  @objc
  public static func decode(_ s: NSString) -> NSDictionary? {
  ...
  @objc
  public static func deepEqualOrdered(_ lhs: Any, rhs: NSDictionary) -> Bool {
