...
- (void)test_maps_deepNest {
  NSError* err = nil;
  NSDictionary* r = [Qs decode:@"foo[bar][baz]=foobarbaz" options:nil error:&err];
  XCTAssertNil(err);
  NSDictionary* foo = r[@"foo"];
...
- (void)test_maps_defaultDepthTrims {
  NSError* err = nil;
  NSDictionary* r = [Qs decode:@"a[b][c][d][e][f][g][h][i]=j" options:nil error:&err];
  XCTAssertNil(err);
  NSDictionary* a = r[@"a"];
  NSDictionary* b = a[@"b"];
  NSDictionary* c = b[@"c"];
...
- (void)test_maps_overrideDepth {
  ...
  opts.depth = 1;
  NSError* err = nil;
  NSDictionary* r = [Qs decode:@"a[b][c][d][e][f][g][h][i]=j" options:opts error:&err];
  XCTAssertNil(err);
  NSDictionary* a = r[@"a"];
  NSDictionary* b = a[@"b"];
...
- (void)test_maps_decodeDotInKeys {
  ...
  NSError* err = nil;
  NSDictionary* r = [Qs decode:@"name%252Eobj.first=John&name%252Eobj.last=Doe" options:opts error:&err];
  XCTAssertNil(err);
...
- (void)test_maps_charsetSentinel_latin1 {
  ...
  NSError* err = nil;
  NSDictionary* r = [Qs decode:@"utf8=%E2%9C%93&a=%C3%B8" options:opts error:&err];
  XCTAssertNil(err);
...
- (void)test_maps_charsetSentinel_utf8 {
  ...
  opts.charsetSentinel = YES;
  NSError* err = nil;
  NSDictionary* r = [Qs decode:@"utf8=%26%2310003%3B&a=%F8" options:opts error:&err];
  XCTAssertNil(err);
  XCTAssertEqualObjects(r[@"a"], @"ø");
}
...
- (void)test_encode_valuesOnly {
  ...
  NSError* err = nil;
  NSDictionary* input = @{ @"a" : @"b", @"c" : @[ @"d", @"e=f" ], @"f" : @[ @[ @"g" ], @[ @"h" ] ] };
...
- (void)test_encode_customEncoder {
  QsEncodeOptions* opts = [QsEncodeOptions new];
  opts.valueEncoderBlock = ^NSString*(id value, NSNumber* charsetNum, NSNumber* formatNum) {
      id v = value ?: @"";
      if ([v isKindOfClass:[NSString class]] && [(NSString*)v isEqualToString:@"č"]) {
        return @"c";
      }
...
- (void)test_encode_encodeDotInKeys_true {
  ...
  NSError* err = nil;
  NSString* s = [Qs encode:@{ @"name.obj" : @ { @"first" : @"John", @"last" : @"Doe" } } options:opts error:&err];
  XCTAssertNil(err);
  NSSet* parts = [NSSet setWithArray:[s componentsSeparatedByString:@"&"]];
  NSSet* expected = [NSSet setWithArray:@[ @"name%252Eobj.first=John", @"name%252Eobj.last=Doe" ]];
  XCTAssertEqualObjects(parts, expected);
}
...
- (void)test_encode_allowEmptyLists_true_encodeFalse {
  ...
  opts.encode = NO;
  NSError* err = nil;
  NSString* s = [Qs encode:@{ @"foo" : @[], @"bar" : @"baz" } options:opts error:&err];
  XCTAssertNil(err);
  NSSet* parts = [NSSet setWithArray:[s componentsSeparatedByString:@"&"]];
...
- (void)test_encode_emptyCollections_emitEmptyString {
  ...
  XCTAssertEqualObjects([Qs encode:@{ @"a" : @ { } } options:nil error:&err], @"");
  XCTAssertEqualObjects([Qs encode:@{ @"a" : @[ @[] ] } options:nil error:&err], @"");
  XCTAssertEqualObjects([Qs encode:@{ @"a" : @ { @"b" : @[] } } options:nil error:&err], @"");
  XCTAssertEqualObjects([Qs encode:@{ @"a" : @ { @"b" : @ { } } } options:nil error:&err], @"");
}

- (void)test_encode_omitsUndefined_properties {
  NSError* err = nil;
  NSString* s = [Qs encode:@{ @"a" : [NSNull null], @"b" : [QsUndefined new] } options:nil error:&err];
  XCTAssertNil(err);
  XCTAssertEqualObjects(s, @"a=");
}
...
- (void)test_encode_addQueryPrefix {
  ...
  NSSet* parts = [NSSet setWithArray:[[s substringFromIndex:1] componentsSeparatedByString:@"&"]];
...
- (void)test_encode_sortKeys_withComparator {
  ...
  NSError* err = nil;
  NSString* s = [Qs encode:@{ @"a" : @"c", @"z" : @"y", @"b" : @"f" } options:opts error:&err];
  XCTAssertNil(err);
...
- (void)test_encode_filter_withFunction {
  ...
  NSDictionary* input = @{ @"a" : @"b", @"c" : @"d", @"e" : @ { @"f" : date, @"g" : @[ @2 ] } };

  QsFunctionFilter* ff = [[QsFunctionFilter alloc] init:^id(NSString* prefix, id value) {
...
- (void)test_encode_filter_withIterable {
  ...
  opts1.encode = NO;
  opts1.filter = [QsFilter iterable:[[QsIterableFilter alloc] initWithIterable:@[ @"a", @"e" ]]];
  NSString* s1 = [Qs encode:@{ @"a" : @"b", @"c" : @"d", @"e" : @"f" } options:opts1 error:&err];
  XCTAssertNil(err);
  ...
  opts2.encode = NO;
  opts2.filter = [QsFilter iterable:[[QsIterableFilter alloc] initWithIterable:@[ @"a", @0, @2 ]]];
  NSString* s2 = [Qs encode:@{ @"a" : @[ @"b", @"c", @"d" ], @"e" : @"f" } options:opts2 error:&err];
  XCTAssertNil(err);
