...
public struct DecodeOptions: @unchecked Sendable {
  ...
  @usableFromInline
  internal let decoder: ScalarDecoder?
  @available(
    *,
    deprecated,
  ...
  @usableFromInline
  internal let legacyDecoder: LegacyDecoder?
  @usableFromInline
  internal let hasLegacyDecoder: Bool
  ...
  internal func decode(
    _ value: String?,
    _ charset: String.Encoding? = nil,
    _ kind: DecodeKind = .value
  ) -> Any? {
    if let dec = decoder {
  ...
  @inline(__always)
  internal var _decoder: ScalarDecoder? { decoder }
