...
struct EncodeTests {
  ...
  func testEmptyListAllowEmptyLists() async throws {
    ...
    #expect(
      try Qs.encode(
        ["a": [] as [String], "b": "zz"],
        options: EncodeOptions(allowEmptyLists: false)
      )
        == "b=zz"
    )
    // allowEmptyLists = true
    #expect(
      try Qs.encode(
        ["a": [] as [String], "b": "zz"],
        options: EncodeOptions(allowEmptyLists: true)
      )
        == "a[]&b=zz"
    )
  }
  ...
  func testSerializeDateOption() async throws {
    ...
    #expect(
      try Qs.encode(
        ["a": specificDate],
        options: EncodeOptions(dateSerializer: customSerializeDate)
      )
        == "a=42"
    )
  ...
  func testRFC1738Serialization() async throws {
    ...
    #expect(
      try Qs.encode(
        ["a b": "a b".data(using: .utf8)!],
        options: EncodeOptions(format: .rfc1738)
      )
        == "a+b=a+b"
    )
    #expect(
  ...
  func testRFC3986SpacesSerialization() async throws {
    ...
    #expect(
      try Qs.encode(
        ["a b": "a b".data(using: .utf8)!],
        options: EncodeOptions(format: .rfc3986)
      )
        == "a%20b=a%20b"
    )
  }
  ...
  func testCharsetSentinelOption() async throws {
    ...
    #expect(
      try Qs.encode(
        ["a": "æ"],
        options: EncodeOptions(charset: .isoLatin1, charsetSentinel: true)
      )
  ...
  func testStrictNullHandlingWithCustomFilter() async throws {
    let options = EncodeOptions(
      filter: FunctionFilter { _, value in value },
      strictNullHandling: true
    )
  ...
  func testEncodesNonStringKeysWithIterableFilter() async throws {
    ...
    let options = EncodeOptions(
      allowDots: true,
      encodeDotInKeys: true,
      filter: IterableFilter(["a", false, NSNull()])
    )
  ...
  func testEncoding_StringifyCommaAndEmptyArrayValues() async throws {
    ...
    #expect(
      try Qs.encode(
        value,
        options: EncodeOptions(listFormat: .indices, encodeValuesOnly: false)
      )
        == "a%5B0%5D=%2C&a%5B1%5D=&a%5B2%5D=c%2Cd%25"
    )
    #expect(
      try Qs.encode(
        value,
        options: EncodeOptions(listFormat: .brackets, encodeValuesOnly: false)
      )
        == "a%5B%5D=%2C&a%5B%5D=&a%5B%5D=c%2Cd%25"
    )
    #expect(
      try Qs.encode(
        value,
        options: EncodeOptions(listFormat: .comma, encodeValuesOnly: false)
      )
        == "a=%2C%2C%2Cc%2Cd%25"
    )
    #expect(
      try Qs.encode(
        value,
        options: EncodeOptions(listFormat: .repeatKey, encodeValuesOnly: false)
      )
        == "a=%2C&a=&a=c%2Cd%25"
    )
  }
  ...
  func cycle_throws() throws {
      ...
      try withKnownIssue(Comment("Linux: self-referential Foundation containers can crash before encoder runs")) {
        #expect(
          Bool(false),
          Comment("Cannot safely build a generic self-cycle on Linux; tracked as known issue.")
        )
      }
    #else
      let a = NSMutableDictionary()
  ...
  func array_cycle_throws() throws {
      ...
      try withKnownIssue(Comment("Linux: corelibs-foundation segfault when constructing NSArray self-cycle")) {
        #expect(
          Bool(false),
          Comment("Cannot safely construct NSArray self-cycle on Linux; tracked as known issue.")
        )
      }
    #else
      let a = NSMutableArray()
