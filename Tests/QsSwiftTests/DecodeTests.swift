...
struct DecodeTests {
  ...
  func qs6153_overflowValuesMergeWithBracketAssignments() throws {
    ...
    #expect(
      NSDictionary(dictionary: sparseValue)
        .isEqual(
          to: ["0": ["1", "x"], "1": "2", "2": "z"]
        )
    )
  ...
  func qs6153_unbalancedBracketOptions() throws {
    ...
    #expect(
      NSDictionary(dictionary: depthFive)
        .isEqual(
          to: ["a": ["b": ["d": ["[f": "v"]]]]
        )
    )
    ...
    #expect(
      NSDictionary(dictionary: depthOne)
        .isEqual(
          to: ["a": ["b": ["[d]e[f": "v"]]]
        )
    )
    ...
    #expect(
      NSDictionary(dictionary: dotted)
        .isEqual(
          to: ["a": ["b": ["[c": "v"]]]
        )
    )
  ...
  func testDecode_AltRegexDelimiter() async throws {
    let r = try Qs.decode(
      "a=b; c=d",
      options: DecodeOptions(delimiter: RegexDelimiter("[;,] *"))
    )
    #expect((r["a"] as? String) == "b")
    #expect((r["c"] as? String) == "d")
  }
  ...
  func testDecode_CommaParsing() async throws {
    ...
    do {
      ...
      let r2 = try Qs.decode(
        "foo",
        options: DecodeOptions(comma: true, strictNullHandling: true)
      )
...
struct DecodeOptionsCustomDecoderParity {
  ...
  func decoderWinsOverLegacyDecoder() throws {
    ...
    typealias Legacy = LegacyDecoder
