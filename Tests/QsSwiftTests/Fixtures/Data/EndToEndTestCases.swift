...
internal struct EndToEndTestCase {
    let data: OrderedDictionary<String, Any>
    let encoded: String
}

internal func endToEndTestCases() -> [EndToEndTestCase] {
    return [
        EndToEndTestCase(
            data: ([:] as OrderedDictionary<String, Any>),
            encoded: ""
        ),
        EndToEndTestCase(
            data: (["a": "b"] as OrderedDictionary<String, Any>),
            encoded: "a=b"
        ),
        EndToEndTestCase(
            data: (["a": "b", "c": "d"] as OrderedDictionary<String, Any>),
            encoded: "a=b&c=d"
        ),
        EndToEndTestCase(
            data: (["a": "b", "c": "d", "e": ["f", "g", "h"]] as OrderedDictionary<String, Any>),
        ...
        EndToEndTestCase(
            data: ([
                ...
                "c": "d",
                "e": ["f", "g", "h"],
                "i": (["j": "k", "l": "m"] as OrderedDictionary<String, Any>),
            ] as OrderedDictionary<String, Any>),
            encoded: "a=b&c=d&e[0]=f&e[1]=g&e[2]=h&i[j]=k&i[l]=m"
        ),
        EndToEndTestCase(
            data: (["a": (["b": "c"] as OrderedDictionary<String, Any>)]
                as OrderedDictionary<String, Any>),
            encoded: "a[b]=c"
        ),
        EndToEndTestCase(
            data: ([
                "a":
                    (["b": (["c": "d"] as OrderedDictionary<String, Any>)]
                    as OrderedDictionary<String, Any>)
            ] as OrderedDictionary<String, Any>),
            encoded: "a[b][c]=d"
        ),
        EndToEndTestCase(
            data: ([
                "a": [
                    (["b": "c"] as OrderedDictionary<String, Any>),
                    (["d": "e"] as OrderedDictionary<String, Any>),
                ]
            ] as OrderedDictionary<String, Any>),
            encoded: "a[0][b]=c&a[1][d]=e"
        ),
        EndToEndTestCase(
            data: (["a": ["f"]] as OrderedDictionary<String, Any>),
            encoded: "a[0]=f"
        ),
        EndToEndTestCase(
            data: ([
        ...
        EndToEndTestCase(
            data: (["a": ""] as OrderedDictionary<String, Any>),
            encoded: "a="
        ),
        EndToEndTestCase(
            data: (["a": ["", "b"]] as OrderedDictionary<String, Any>),
        ...
        EndToEndTestCase(
            data: (["キー": "値"] as OrderedDictionary<String, Any>),
            encoded: "キー=値"
        ),
        EndToEndTestCase(
            data: (["🙂": "😊"] as OrderedDictionary<String, Any>),
        ...
        EndToEndTestCase(
            data: ([
                "filters":
                    ([
                        "$or": [
                            (["date": (["$eq": "2020-01-01"] as OrderedDictionary<String, Any>)]
                                as OrderedDictionary<String, Any>),
                            (["date": (["$eq": "2020-01-02"] as OrderedDictionary<String, Any>)]
                                as OrderedDictionary<String, Any>),
                        ],
                        "author":
                            (["name": (["$eq": "John Doe"] as OrderedDictionary<String, Any>)]
                            as OrderedDictionary<String, Any>),
                    ] as OrderedDictionary<String, Any>)
            ] as OrderedDictionary<String, Any>),
            encoded:
                        ...
                        "relationships":
                            ([
                                "tags":
                                    ([
                                        "data": [
                                            (["name": "super"] as OrderedDictionary<String, Any>),
                                            (["name": "awesome"] as OrderedDictionary<String, Any>),
                                        ]
                                    ] as OrderedDictionary<String, Any>)
                            ] as OrderedDictionary<String, Any>),
                    ] as OrderedDictionary<String, Any>)
