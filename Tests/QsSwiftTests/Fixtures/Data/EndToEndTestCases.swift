...
internal func endToEndTestCases() -> [EndToEndTestCase] {
    return [
        EndToEndTestCase(data: [:], encoded: ""),
        EndToEndTestCase(data: ["a": "b"], encoded: "a=b"),
        EndToEndTestCase(data: ["a": "b", "c": "d"], encoded: "a=b&c=d"),
        EndToEndTestCase(data: ["a": "b", "c": "d", "e": "f"], encoded: "a=b&c=d&e=f"),
        EndToEndTestCase(
        ...
        EndToEndTestCase(data: ["a": ["b": "c"]], encoded: "a[b]=c"),
        EndToEndTestCase(data: ["a": ["b": ["c": "d"]]], encoded: "a[b][c]=d"),
        EndToEndTestCase(data: ["a": [["b": "c"], ["d": "e"]]], encoded: "a[0][b]=c&a[1][d]=e"),
        EndToEndTestCase(data: ["a": ["f"]], encoded: "a[0]=f"),
        EndToEndTestCase(data: ["a": [["b": ["c"]]]], encoded: "a[0][b][0]=c"),
        EndToEndTestCase(data: ["a": ""], encoded: "a="),
        EndToEndTestCase(data: ["a": ["", "b"]], encoded: "a[0]=&a[1]=b"),
        EndToEndTestCase(data: ["キー": "値"], encoded: "キー=値"),
        EndToEndTestCase(data: ["🙂": "😊"], encoded: "🙂=😊"),
        EndToEndTestCase(
            data: [
                "filters": [
