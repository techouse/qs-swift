...
private let benchLocale = Locale(identifier: "en_US_POSIX")
...
func benchCommaList(_ N: Int) throws {
    ...
    print(String(format: "elapsed: %.6f s", locale: benchLocale, elapsed))
}
...
private func perfSnapshot() throws {
    ...
    for c in deepEncodeCases {
        ...
        print(
            String(
                format: "  swift depth=%5d: %8.3f ms/op | len=%d",
                locale: benchLocale,
                c.depth,
                ms,
                outLength
        ...
        for c in deepEncodeCases {
            ...
            print(
                String(
                    format: "  objc  depth=%5d: %8.3f ms/op | len=%d",
                    locale: benchLocale,
                    c.depth,
                    ms,
                    outLength
